...
"""class Coin(pygame.sprite.Sprite):
    ...
    def move(self):
        if self.rect[1] + self.rect[3] < HEIGHT:
            ...
            self.rect.center = (random.randint(self.rect[2] // 2, WIDTH - self.rect[2] // 2,HEIGHT-self.rect[2]), 35)
"""
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.raw_image = pygame.image.load("Coin.png").convert_alpha()
        self.image = pygame.Surface((30, 30), pygame.SRCALPHA)
        pygame.draw.circle(self.image, (255, 255, 0), (15, 15), 15)  
        self.image.blit(self.raw_image, (0, 0))  
        self.rect = self.image.get_rect() 
    ...
    def move(self):
        if self.rect[1] + self.rect[3] < HEIGHT:
            ...
            self.rect.center = (random.randint(self.rect.width // 2, WIDTH - self.rect.width // 2), HEIGHT - self.rect.width)
        if pygame.sprite.spritecollideany(P1, coins):
            all_sprites.remove(coins)
            pygame.display.flip()
